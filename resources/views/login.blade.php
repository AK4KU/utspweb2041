...
<style>
    ...
    <h2 class="text-3xl font-bold mb-4 text-blue-600">Login</h2>
    ...
    <form action="/login" method="POST">
        ...
        <!-- Jika ada notifikasi sukses (dari register), tampilkan di sini -->
        @if(session('success'))
        ...
        <div class="mt-4">
            <a href="/register" class="text-blue-600 hover:text-blue-800 text-sm">Don't have an account? Register here</a>
        </div>
    </form>
@endsection
